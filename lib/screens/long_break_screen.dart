...
class LongBreakScreen extends StatefulWidget {
  static const String id = "long_break_screen";
...
class _LongBreakScreenState extends State<LongBreakScreen> with MixinVariables {
  int secondsCount = 0;
  int minutesCount = 0;
  late Timer timer;
  bool started = false;
...
// I checked if pomodoro long break page is working properly with making it 2 minutes after finishing checking I change it back to 10. If you have any doubts you can check yourself.
        if (minutesCount == 10) {
          timer.cancel();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(TextsClass.textAboveTimer3,
                  style: TextStyle(
                      color: ColorsClass.white,
                      fontFamily: "Ramabhadra",
                      fontSize: 29,
